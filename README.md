...
Look-and-feel refinements after live-site review:

- Desktop landing is sized to the visible viewport to avoid the unnecessary small vertical scroll.
- Landing avatar is raised, slightly enlarged, and vertically centred in its half of the hero.
- GitHub links use the actual GitHub mark instead of a generic filled circle.
- Publication search and filter controls use a white background, dark text, and clearer placeholder/focus states.
